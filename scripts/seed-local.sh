...
./scripts/mintTestToken.sh 0x70997970C51812dc3A010C7d01b50e0d17dc79C8 50000000000000000000000 > /dev/null
# Mint 50,000 test tokens to Anvil account(2) to be a subscriber
./scripts/mintTestToken.sh 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC 50000000000000000000000 > /dev/null
